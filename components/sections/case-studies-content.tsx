...
const caseStudies = [
    ...
    },
    {
        ...
        title: 'National Cybersecurity Shield',
        client: 'Ministry of Interior',
        desc: 'Implementing a nationwide threat intelligence and response system.',
        results: ['99.9% Threat Block', '24/7 Monitoring'],
        icon: ShieldCheck,
        image: '/media/real/cybersecurity.jpg',
    },
    {
        id: 'retail-ecom-platform',
        title: 'Omnichannel Retail Platform',
        client: 'Major Retailer',
        desc: 'Building a unified e-commerce experience across web and mobile app.',
        results: ['200% Sales Growth', 'Unified Inventory'],
        icon: Zap,
